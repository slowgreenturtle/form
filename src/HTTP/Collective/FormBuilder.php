...
class FormBuilder
{
    ...
    public function getValueAttribute($name, $value = null)
    {
        ...
        if (function_exists('app'))
        {
            ...
            if (
                $hasNullMiddleware && is_null($old) && is_null($value) && !is_null($this->view->shared('errors')) && count(is_countable($this->view->shared('errors')) ? $this->view->shared('errors') : []) > 0
            )
            {
                return null;
            }
