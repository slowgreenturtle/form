...
class DataManage
{
    ...
    protected $backup_to_ftp     = false;
    protected $delete_limit      = 1;
    protected $local_backup_path = 'database';
    protected $multi_tenant      = false;        //  how many days in the past do we want to remove?
    protected $s3_backup_path    = 'backup';     //App/config/ftp.php must be configured for this to work properly.
    protected $system_connection = null;
    protected $tenant_connection = 'team';  # local storage relative backup path.
    ...
    protected function databaseImport($params)
    {
        ...
        $connection     = Arr::get($params, 'connection');
        $exclude_list   = Arr::get($params, 'exclude_tables', []);
        $schema_only    = Arr::get($params, 'schema_only', false);
        $exclude_tables = [];
